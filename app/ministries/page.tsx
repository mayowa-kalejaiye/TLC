    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden">
        ...
        <div className="absolute inset-0 z-0 opacity-10">
          <div className="absolute top-20 left-10 w-96 h-96 bg-tlcc-gold rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 right-10 w-96 h-96 bg-tlcc-orange rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
        </div>

        <div className="container-custom relative z-10 text-center text-white">
          <div className="inline-flex items-center gap-2 bg-tlcc-gold/20 backdrop-blur-sm px-6 py-3 rounded-full mb-8 border border-tlcc-gold/30">
          ...
          <h1 className="font-anton text-5xl md:text-7xl lg:text-8xl mb-8 uppercase leading-tight">
            There&apos;s A Place<br />
            <span className="text-tlcc-gold">For Everyone</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#departments"
              className="inline-flex items-center px-8 py-4 bg-tlcc-gold hover:bg-tlcc-orange text-white font-bold rounded-full transition-all duration-300 shadow-xl hover:shadow-2xl hover:scale-105"
            >
            ...
            <Link
              ...
              className="inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-md border-2 border-white hover:bg-white hover:text-tlcc-navy font-bold rounded-full transition-all duration-300 hover:scale-105"
            >
              Join Now
            </Link>
          </div>
      ...
      {/* Why Serve Section */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-white to-tlcc-cream">
        <div className="container-custom">
          <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="font-anton text-4xl md:text-5xl text-tlcc-navy mb-6 uppercase">
              Why <span className="text-tlcc-orange">Serve?</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-tlcc-cream hover:border-tlcc-gold transition-all hover:-translate-y-1">
              <div className="text-4xl mb-4">🌱</div>
              <h3 className="font-bold text-xl text-tlcc-navy mb-3">Grow Spiritually</h3>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-tlcc-cream hover:border-tlcc-gold transition-all hover:-translate-y-1">
              <div className="text-4xl mb-4">🎁</div>
              <h3 className="font-bold text-xl text-tlcc-navy mb-3">Discover Your Gifts</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-tlcc-cream hover:border-tlcc-gold transition-all hover:-translate-y-1">
              <div className="text-4xl mb-4">🤝</div>
              <h3 className="font-bold text-xl text-tlcc-navy mb-3">Build Community</h3>
              <p className="text-gray-600">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg border-2 border-tlcc-cream hover:border-tlcc-gold transition-all hover:-translate-y-1">
              <div className="text-4xl mb-4">⚡</div>
              <h3 className="font-bold text-xl text-tlcc-navy mb-3">Make Impact</h3>
              <p className="text-gray-600">
      ...
      <section id="departments" className="py-16 md:py-24 bg-white">
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2 className="font-anton text-4xl md:text-6xl text-tlcc-navy mb-6 uppercase">
              Our <span className="text-tlcc-orange">Departments</span>
            </h2>
          ...
          <div className="space-y-16">
            {departments.map((dept) => (
              <div
                key={dept.id}
                id={dept.id}
                className="scroll-mt-24 bg-gradient-to-br from-white to-tlcc-cream rounded-3xl shadow-xl overflow-hidden border-2 border-tlcc-cream hover:border-tlcc-gold transition-all"
              >
                <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-8 p-8 md:p-12">
                  ...
                  <div className="flex flex-col items-center lg:items-start text-center lg:text-left">
                    ...
                    <h3 className="font-anton text-3xl md:text-4xl text-tlcc-navy mb-4 uppercase">
                      {dept.name}
                    </h3>
                    ...
                    <Link
                      ...
                      className="inline-flex items-center px-6 py-3 bg-tlcc-gold hover:bg-tlcc-orange text-white font-bold rounded-full transition-all duration-300 shadow-lg hover:shadow-xl hover:scale-105"
                    >
                      Join This Ministry
                      <ArrowRight className="h-5 w-5 ml-2" />
                    </Link>
                  ...
                  <div className="space-y-8">
                    {/* Mission */}
                    <div>
                      <h4 className="font-bold text-xl text-tlcc-navy mb-3 flex items-center">
                    ...
                    {/* Activities */}
                    <div>
                      <h4 className="font-bold text-xl text-tlcc-navy mb-4 flex items-center">
                        <span className="text-2xl mr-2">✨</span>
                        What We Do
                      </h4>
                      <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        {dept.activities.map((activity) => (
                          <div key={activity} className="flex items-start gap-2">
                            <CheckCircle className="h-5 w-5 text-tlcc-gold flex-shrink-0 mt-0.5" />
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        {dept.requirements.map((req) => (
                          <div key={req} className="flex items-start gap-2 bg-white rounded-lg p-3 border border-tlcc-cream">
                            <span className="text-tlcc-gold font-bold flex-shrink-0">•</span>
      ...
      {/* Other Ministries */}
      <section className="py-16 md:py-24 bg-gradient-to-b from-tlcc-cream to-white">
        <div className="container-custom">
          <div className="text-center mb-12">
            <h2 className="font-anton text-4xl md:text-5xl text-tlcc-navy mb-6 uppercase">
              More <span className="text-tlcc-orange">Opportunities</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {otherMinistries.map((ministry) => (
              <div
                key={ministry.name}
                className="bg-white rounded-2xl p-8 shadow-lg border-2 border-tlcc-cream hover:border-tlcc-gold transition-all hover:-translate-y-2 group"
              >
                <div className="inline-flex p-4 bg-tlcc-gold/10 rounded-2xl mb-4 group-hover:bg-tlcc-gold/20 transition-all">
                  <ministry.icon className="h-8 w-8 text-tlcc-gold" />
                </div>
                ...
                <Link
                  href="/contact#join-ministry"
                  className="inline-flex items-center text-tlcc-gold hover:text-tlcc-orange font-semibold text-sm group-hover:translate-x-1 transition-transform"
                >
                  Learn More
      ...
      {/* How to Join Section */}
      <section className="py-16 md:py-24 bg-gradient-to-br from-tlcc-navy via-tlcc-green to-tlcc-navy text-white relative overflow-hidden">
        {/* Animated Background */}
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-20 right-20 w-96 h-96 bg-tlcc-gold rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-20 left-20 w-96 h-96 bg-tlcc-orange rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
        </div>
        ...
        <div className="container-custom relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-12">
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-tlcc-gold rounded-full text-2xl font-bold text-white mb-4">
                1
              </div>
          ...
          <div className="text-center">
            <Link
              href="/contact#join-ministry"
              className="inline-flex items-center px-10 py-5 bg-tlcc-gold hover:bg-tlcc-orange text-white font-bold rounded-full transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-110 text-lg"
            >
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="container-custom max-w-4xl">
          <div className="text-center mb-12">
            <h2 className="font-anton text-4xl md:text-5xl text-tlcc-navy mb-6 uppercase">
              Common <span className="text-tlcc-orange">Questions</span>
            </h2>
          </div>

          <div className="space-y-6">
            <div className="bg-tlcc-cream rounded-2xl p-6 md:p-8 border-2 border-transparent hover:border-tlcc-gold transition-all">
              <h3 className="font-bold text-xl text-tlcc-navy mb-3">
