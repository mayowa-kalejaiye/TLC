...
const en: Messages = {
  ...
  hero: {
    ...
    // Rooted December/Living in Abundance event removed — keep neutral placeholders
    featuredTagline: '',
    featuredDetails: '',
    registerCta: 'See Events',
...
const fr: Messages = {
  ...
  hero: {
    ...
    // Featured event removed — keep neutral placeholders
    featuredTagline: '',
    featuredDetails: '',
    registerCta: 'Voir les événements',
