      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          <div className="inline-flex items-center space-x-2 bg-tlcc-gold/20 backdrop-blur-sm px-6 py-2 rounded-full mb-6 border border-tlcc-gold/30">
            ...
            <span className="text-tlcc-gold font-bold text-sm tracking-widest uppercase">Our Reach</span>
          </div>
          ...
          <h2 className="font-anton text-5xl sm:text-6xl md:text-7xl lg:text-8xl mb-4 uppercase leading-none">
            ...
            <span className="text-tlcc-orange">Many Nations.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16 max-w-2xl mx-auto">
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 hover:bg-white/20 transition-all">
            <div className="text-4xl md:text-5xl font-anton text-tlcc-gold mb-2">24/7</div>
            <p className="text-sm text-white/80 uppercase tracking-wider">Online Access</p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 hover:bg-white/20 transition-all">
            <div className="text-4xl md:text-5xl font-anton text-tlcc-orange mb-2">∞</div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="relative">
            <div className="bg-gradient-to-br from-tlcc-gold/20 to-tlcc-orange/20 backdrop-blur-md rounded-3xl overflow-hidden border-2 border-tlcc-gold/30">
              <div className="p-8 pb-0">
                <h3 className="font-anton text-2xl md:text-3xl text-tlcc-gold mb-6 uppercase">Our Global Footprint</h3>
              </div>
              ...
              <div className="relative w-full h-64 md:h-80 mb-6">
                <Image
                  ...
                  alt="The Light Community Church Global Reach"
                  fill
              ...
              <div className="space-y-3 p-8 pt-0">
                <div className="flex items-center space-x-3 bg-black/30 rounded-lg p-3">
                  <div className="w-3 h-3 bg-tlcc-gold rounded-full animate-pulse"></div>
                  <span className="text-sm text-white">Physical Hub: Lagos, Nigeria</span>
                </div>
                <div className="flex items-center space-x-3 bg-black/30 rounded-lg p-3">
                  <div className="w-3 h-3 bg-tlcc-orange rounded-full animate-pulse"></div>
                  <span className="text-sm text-white">Digital Reach: The Light Community Church</span>
                </div>
                <div className="flex items-center space-x-3 bg-black/30 rounded-lg p-3">
                  <div className="w-3 h-3 bg-tlcc-gold rounded-full animate-pulse"></div>
          ...
          <div className="space-y-6">
            <h3 className="font-anton text-3xl md:text-4xl text-white uppercase">
              One Family.<br />
              <span className="text-tlcc-gold">Infinite Possibilities.</span>
            </h3>
            
            <p className="text-lg text-white/90 leading-relaxed">
              Though we gather in <span className="text-tlcc-gold font-semibold">one place</span>, our heart beats for <span className="text-tlcc-orange font-semibold">the world</span>. We are a single, vibrant family at The Light Community Church, but our mission extends across the globe.
            </p>
            
            <p className="text-lg text-white/90 leading-relaxed">
              Through our <span className="text-tlcc-gold font-semibold">online services</span>, partnerships, and a vision to plant life-giving churches, we are part of God&apos;s work right here in Lagos and to the <span className="text-tlcc-orange font-semibold">ends of the earth</span>.
            </p>

            <div className="bg-tlcc-gold/10 backdrop-blur-sm border-l-4 border-tlcc-gold rounded-r-xl p-6">
              <p className="text-white italic text-lg">
                &ldquo;Young people <span className="text-tlcc-gold font-bold">primed to take the nations</span>.&rdquo;
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              <div className="text-center p-4 bg-white/5 rounded-xl">
                <p className="text-2xl font-anton text-tlcc-gold mb-1">Tuesday & Saturday</p>
                <p className="text-xs text-white/70 uppercase tracking-wider">Live Online Services</p>
              </div>
              <div className="text-center p-4 bg-white/5 rounded-xl">
                <p className="text-2xl font-anton text-tlcc-orange mb-1">First Saturday</p>
        ...
        <div className="mb-16">
          <h3 className="font-anton text-3xl md:text-4xl text-center text-white mb-12 uppercase">
            <span className="text-tlcc-gold">How We</span> Connect The World
          </h3>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Online */}
            <div className="relative group">
              <div className="bg-gradient-to-br from-tlcc-gold/20 to-transparent backdrop-blur-sm rounded-2xl p-8 border-2 border-tlcc-gold/40 hover:border-tlcc-gold transition-all h-full">
                <div className="w-16 h-16 bg-tlcc-gold rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                ...
                <Link 
                  ...
                  target="_blank"
                  className="text-tlcc-gold hover:text-tlcc-gold-light font-semibold inline-flex items-center"
                >
            ...
            {/* Physical */}
            <div className="relative group">
              <div className="bg-gradient-to-br from-tlcc-orange/20 to-transparent backdrop-blur-sm rounded-2xl p-8 border-2 border-tlcc-orange/40 hover:border-tlcc-orange transition-all h-full">
                <div className="w-16 h-16 bg-tlcc-orange rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                ...
                <Link 
                  href="/map"
                  className="text-tlcc-orange hover:text-tlcc-orange-light font-semibold inline-flex items-center"
                >
        ...
        <div className="relative">
          <div className="bg-gradient-to-r from-tlcc-gold via-tlcc-orange to-tlcc-gold bg-[length:200%_100%] animate-gradient rounded-3xl p-12 md:p-16 text-center border-4 border-white/20 shadow-2xl">
            <h3 className="font-anton text-4xl md:text-5xl lg:text-6xl text-white mb-6 uppercase leading-tight">
              Your Story<br />
              <span className="text-tlcc-navy">Starts Here</span>
            </h3>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                ...
                className="px-12 py-5 bg-white text-tlcc-navy font-anton text-xl uppercase rounded-full hover:bg-tlcc-navy hover:text-white transition-all duration-300 transform hover:scale-105 shadow-xl"
              >
                Join Us Online
              </Link>
              ...
              <Link
                href="/map"
                className="px-12 py-5 bg-tlcc-navy text-white font-anton text-xl uppercase rounded-full hover:bg-white hover:text-tlcc-navy transition-all duration-300 transform hover:scale-105 border-4 border-white shadow-xl"
              >
                Visit In Person
              </Link>
            </div>
