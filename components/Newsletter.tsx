  ...
  return (
    <section id="stay-connected" className="py-16 md:py-24 bg-gradient-to-br from-white via-tlcc-cream to-white relative overflow-hidden scroll-mt-24 z-20">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-10 right-20 w-72 h-72 bg-tlcc-gold/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-10 left-20 w-96 h-96 bg-tlcc-orange/10 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1.5s' }}></div>
      </div>
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          {/* Form Section */}
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 border border-tlcc-cream mb-8">
            <form onSubmit={handleSubmit} className="max-w-xl mx-auto">
              <div className="flex flex-col sm:flex-row gap-4">
                <div className="relative flex-1">
                  <Mail className="absolute left-4 top-1/2 transform -translate-y-1/2 h-5 w-5 text-tlcc-navy-light" />
                  <input
                    type="email"
                    value={email}
