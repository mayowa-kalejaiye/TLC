          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <div>
                  <p className="text-xs text-tlcc-navy-light uppercase tracking-wide">Today&apos;s Devotional</p>
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-tlcc-navy mb-1">Daily Content</h4>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-tlcc-navy mb-1">Email Delivery</h4>
                    <p className="text-sm text-tlcc-navy-light">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    <h4 className="font-semibold text-tlcc-navy mb-1">Practical Insights</h4>
                    <p className="text-sm text-tlcc-navy-light">
