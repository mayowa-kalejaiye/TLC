      ...
      <div className="container-custom">
        <div className="text-center mb-16">
          <div className="inline-flex items-center space-x-2 bg-tlcc-gold/10 px-6 py-2 rounded-full mb-4">
            ...
            <span className="text-tlcc-gold font-bold text-sm tracking-wider uppercase">Join A Ministry</span>
          </div>
          <h2 className="font-anton text-4xl md:text-5xl lg:text-6xl text-tlcc-navy mb-6 uppercase">
            There&apos;s a Place<br />
            <span className="text-tlcc-orange">For Everyone</span>
          </h2>
          <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-tlcc-navy font-semibold"> we have a place for you to thrive</span>.
          </p>
        </div>
